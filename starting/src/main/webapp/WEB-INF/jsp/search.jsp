...
<link rel="stylesheet" type="text/css"
	href="/starting/static/css/bootstrap-editable.css">
...
<body>
	...
	<div class="container">
		<form action="/starting/search" method="post">
			<label><strong>City:</strong></label> <select name="city" id="city"
				required="required">
			...
			<label><strong>Start Date:</strong></label><input type="text"
				class="span2" name="begindate" value="" id="dp1"> <br>
			<label><strong>End Date:</strong></label><input type="text"
				class="span2" name="enddate" value="" id="dp2"> <br> <input
				type="radio" name="searchType" value="requested_services"
				checked="checked"> I want to see requested services <br>
			<input type="radio" name="searchType" value="offered_services">
			I want to see offered services <br> <br> <label>Search:</label>
								...
								<div class="accordion" id="accordion1">
									<c:forEach items="${requestedServices}" var="service">
										<tr>
													...
													<div class="accordion-heading">
														<div>
															<a class="accordion-toggle" data-toggle="collapse"
																...
																href="#collapserequest${service.id}">${service.title}</a>
														</div>
													</div>

													<div id="collapserequest${service.id}"
											...
											<td><a class="btn btn-primary" href="" type="button">Apply</a></td>
										</tr>
									</c:forEach>
								</div>

							</td>
							<td><fmt:formatDate dateStyle="short"
									value="${service.beginDate}"></fmt:formatDate></td>
							<td><fmt:formatDate dateStyle="short"
									value="${service.endDate}"></fmt:formatDate></td>
							...
							<td>
								<div class="accordion-group">
									<div class="accordion-heading">
										<div>
											<a class="accordion-toggle" data-toggle="collapse"
												data-parent="#accordion2" href="#collapseoffer${service.id}">${service.title}</a>
										</div>
									</div>
									...
									<div id="collapseoffer${service.id}"
										...
										<div class="accordion-inner">
											...
											<fmt:formatDate dateStyle="short"
												value="${service.beginDate}"></fmt:formatDate>
											<fmt:formatDate dateStyle="short" value="${service.endDate}"></fmt:formatDate>
										</div>
									</div>
								</div>
							</td>
